...
//			}
	...
	function CheckTiempo($MarcaTiempo)
	{
		...
		if(!$MarcaTiempo['m'][0]['iontime'])
			$MarcaTiempo['m'][0]['hora'] = "<u>".$MarcaTiempo['m'][0]['hora']."</u>";
		if(!$MarcaTiempo['m'][1]['iontime'])
			$MarcaTiempo['m'][1]['hora'] = "<u>".$MarcaTiempo['m'][1]['hora']."</u>";
		if(!$MarcaTiempo['t'][0]['iontime'])
			$MarcaTiempo['t'][0]['hora'] = "<u>".$MarcaTiempo['t'][0]['hora']."</u>";
		if(!$MarcaTiempo['t'][1]['iontime'])
			$MarcaTiempo['t'][1]['hora'] = "<u>".$MarcaTiempo['t'][1]['hora']."</u>";
